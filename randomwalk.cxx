...
void condition(int* const rx, int* const ry,const int& N);
void pusher(colloid* const c, int* const rx, int* const ry, const int& N, const double& step);
...
int main(void){
	...
	for(int j = 0; j < Nsubsteps; j++){
	    condition(rx,ry,N);				// call to function which randomly sets up rx and ry
